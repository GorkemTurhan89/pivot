...
namespace Pivot.Migrations
{
    ...
    [Migration("20260531130819_ReplaceIsSuperAdminWithRole")]
    partial class ReplaceIsSuperAdminWithRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pivot.Models.Entities.ExtraServiceDetail", b =>
                {
                    b.Property<int>("PaymentPlanId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DefaultPriceText")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
                    ...
                    b.ToTable("extraservicedetails", (string)null);
                });
            ...
            modelBuilder.Entity("Pivot.Models.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pivot.Models.Entities.ExtraServiceDetail", b =>
                {
                    b.HasOne("Pivot.Models.Entities.PaymentPlan", "PaymentPlan")
                        .WithOne()
                        .HasForeignKey("Pivot.Models.Entities.ExtraServiceDetail", "PaymentPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
